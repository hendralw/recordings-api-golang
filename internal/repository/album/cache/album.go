...
func (repo *albumConnection) GetAlbum(ctx context.Context, id uuid.UUID) (*entity.Album, error) {
...
func (repo *albumConnection) SetAlbum(ctx context.Context, id uuid.UUID, album entity.Album) error {
	key := fmt.Sprintf(albumDetailKey, id)
